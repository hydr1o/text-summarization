...
if __name__ == "__main__": 
	...
	[6] The outbreak was identified in Wuhan, China, in December 2019.[4][7] The World Health Organization declared the outbreak a Public Health Emergency of 
	International Concern on 30 January, and a pandemic on 11 March.[8][9] As of 7 May 2020, more than 3.77 million cases of COVID-19 have been reported in over 187 countries and territories,
	resulting in more than 264,000 deaths. More than 1.25 million people have recovered.[5]. The virus is primarily spread between people during close contact,[c] often via small droplets produced by coughing,
	[d] sneezing, and talking.[10][11][13] The droplets usually fall to the ground or onto surfaces rather than remaining in the air over long distances.
	[10] People may also become infected by touching a contaminated surface and then touching their face.[10][11] On surfaces,
	the amount of virus declines over time until it is insufficient to remain infectious, but it may be detected for hours or days.[10][13][14]
	It is most contagious during the first three days after the onset of symptoms, 
	although spread may be possible before symptoms appear and in later stages of the disease.[15]. Common symptoms include fever, cough, 
	fatigue, shortness of breath, and loss of smell.[10][16][17] Complications may include pneumonia and acute respiratory distress syndrome.[18] The time from exposure to onset of 
	symptoms is typically around five days, but may range from two to fourteen days.[19][20] There is no known vaccine or 
	specific antiviral treatment.[10] Primary treatment is symptomatic and supportive therapy.[21]. Recommended preventive measures include
	hand washing, covering one\'s mouth when coughing, maintaining distance from other people, wearing a face mask in public settings, and monitoring 
	and self-isolation for people who suspect they are infected.[10][22] Authorities worldwide have responded by implementing travel restrictions, lockdowns, workplace hazard controls, and facility closures. Many places have also worked to increase testing capacity and trace contacts of infected persons. The pandemic has caused severe global socioeconomic disruption,[23] including the largest global recession since the Great Depression.[24] It has led to the postponement or cancellation of sporting, religious, political and cultural events,[25] widespread supply shortages exacerbated by panic buying,[26][27] and decreased emissions of pollutants and greenhouse gases.[28][29] Schools, universities and colleges have closed either on a nationwide or local basis in 194 countries, affecting approximately 98.5 per cent of the world\'s student population.[30] Misinformation about the virus has spread online,[31] and there have been incidents of xenophobia and discrimination against Chinese people and against those perceived as being Chinese,
	or as being from areas with high infection rates.[32][33][34]""")
